L.Control.AstroMousePosition = L.Control.extend({
  ...
  onAdd: function (map) {
    this._container = L.DomUtil.create('div', 'leaflet-control-astromouseposition');
  ...
  _onMouseMove: function (e) {
    ...
    cords = this.astroMath.latLonSwitcher(lat, lng, this.lonTo180, this.planetocentric, 
                            this.postiveEast, dMajorRadius, dMinorRadius);
...
L.control.astroMousePosition = function (options) {
